  ...
  for query_str, html_ext, stat_version in query_strs:
    for tank_id, tank_name in valid_tanks:
        ...
        for idx, row in enumerate(rows, 1):
          ...
          row_html.append('<td><a href="../../players/?player_name={}&v={}&server={}">{}</a></td>'.format(row[0], html_ext, server, row[0]))
        ...
        with open('templates/{}/tanks/{}_{}.html'.format(server, tank_id, html_ext), 'w') as f:
